...
public class Simulation {
   ...
   public static void main(String[] args) {
      ...
      Map<Transaction, Integer> consensusCounter = new HashMap<>();
      // print results
      for (int i = 0; i < numNodes; i++) {
         ...
         for (Transaction tx : transactions) {
        	consensusCounter.put(tx, consensusCounter.getOrDefault(tx, 0) + 1);
      ...
      for (Transaction tx : consensusCounter.keySet()) {
    	  System.out.println(tx.id + " " + consensusCounter.get(tx));
      }
